...
<Response>
    ...
    <?php elseif($_REQUEST['Digits'] == '0'): ?>
        <Gather numDigits="1" action="complete_call.php?data=<?php echo $_REQUEST['data']; ?>"><Say voice="woman">A customer at the number <?php echo $user_phone_words?> is calling.</Say><Pause length="1"/><?php echo $datax; ?></Gather>
